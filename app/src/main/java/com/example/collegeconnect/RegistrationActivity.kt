...
class RegistrationActivity : AppCompatActivity() {
    ...
    fun validate(v: View?) {
        ...
        val address = (findViewById<View>(R.id.address) as EditText).text.toString().uppercase(Locale.getDefault())
...
class Student{
    ...
    constructor(name:String,usn:String,branch:String,year:String,sec:String,email:String,mobile:String,address:String,password:String,url:String,label1:String,label2:String){
        this.name=name
        this.usn=usn
        this.branch=branch
        this.year=year
    ...
    constructor(name:String,usn:String,branch:String,year:String,sec:String,email:String,mobile:String,address:String,password:String,url:String){
        this.name=name
        this.usn=usn
        this.branch=branch
        this.year=year
