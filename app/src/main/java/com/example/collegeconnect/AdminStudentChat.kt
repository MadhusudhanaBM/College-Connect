...
class AdminStudentChat : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_student_chat)
    ...
    fun search(v: View?) {
        var i=intent
        var FBr =(findViewById<View>(R.id.branch)as Spinner).selectedItem.toString()
            ...
            object : FirestoreRecyclerAdapter<Student?, RecyclerView.ViewHolder?>(options) {
                ...
                override fun onBindViewHolder(
                    ...
                    if (model.image != "") {
                        ...
                        Glide.with(this@AdminStudentChat).load(model.image)
