...
import kotlinx.android.synthetic.main.chat_from_row.view.name_from
import kotlinx.android.synthetic.main.chat_to_row.view.*
import kotlinx.android.synthetic.main.chat_to_row.view.name_to
...
class ChatActivity : AppCompatActivity() {
    ...
    private fun listenForMessages() {
        ...
        val ref = FirebaseFirestore.getInstance().collection("UserMessages").document(fromID)
            .collection(toID).orderBy("timestamp")
                    ...
                    if (dc.type == DocumentChange.Type.ADDED) {
                        ...
                        if (dc.document.get("doc") == "text") {
                            if (dc.document.get("fromID").toString().equals(fromID)) {
                                ...
                                adapter.add(ChatToItem(dc.document.get("text").toString(), toname))
                            }
