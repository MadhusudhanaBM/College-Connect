...
public final class ActivityFacultyChatFacultyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFacultyChatFacultyBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityFacultyChatFacultyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFacultyChatFacultyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_faculty_chat_faculty, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFacultyChatFacultyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFacultyChatFacultyBinding((ConstraintLayout) rootView, branch, button11,
