...
public final class ActivityFacChangePasswordBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFacChangePasswordBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityFacChangePasswordBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFacChangePasswordBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fac_change_password, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFacChangePasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFacChangePasswordBinding((ConstraintLayout) rootView, button4, confirmpass,
          currentpass, newpass, textView10, textView12, textView32, textview23);
    }
