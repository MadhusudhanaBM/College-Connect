...
public final class ChatToRowBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textToRow;

  private ChatToRowBinding(@NonNull ConstraintLayout rootView, @NonNull TextView nameTo,
      @NonNull TextView textToRow) {
    this.rootView = rootView;
    this.nameTo = nameTo;
    this.textToRow = textToRow;
  }
  ...
  public static ChatToRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_to_row;
      TextView textToRow = rootView.findViewById(id);
      if (textToRow == null) {
        break missingId;
      }

      return new ChatToRowBinding((ConstraintLayout) rootView, nameTo, textToRow);
    }
